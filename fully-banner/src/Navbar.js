...
class Navbar extends Component {
  ...
  render() {
    return <header  className="navbar-expand-lg navbar-light navMargin">
      <div className="d-flex justify-content-between">
        <a onClick={this.clickLogo} className="navbar-brand" href="https://fullystudios.se/">
          <svg style={getImageStyle()} className="image" id="img"  xmlns="http://www.w3.org/2000/svg" width="463.13" height="431.42"
        ...
        <div className="align-self-center d-flex justify-content-between" style={{ flexGrow: 0.04 }}>
          ...
          <a style={ getModeStyle()} href={'?mode=articleMode'}>Article mode</a>
        </div>
