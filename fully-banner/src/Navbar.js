...
import './App.css';
import { getModeStyle, getLogoStyle } from './modeHelper';
...
class Navbar extends Component {
  ...
  render() {
    return <div className="navBar">
      <button href="#" type="button" className="button button--nav " ref="openmenu" id="openmenu"  
      onClick={this.clickHambuger}>
       ...
       <div className="mode-selector" style={{ flexGrow: 0.04 }}>
        ...
        <a onClick={this.clickLogo} className="" href="https://fullystudios.se/">
          <svg style={getLogoStyle()} className="image" id="img" xmlns="http://www.w3.org/2000/svg" width="463.13" height="431.42"
