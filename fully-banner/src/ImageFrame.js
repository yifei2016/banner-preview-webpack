          ...
          <div className={this.state.className} style={{marginTop:'2.1em', display:'flex'}}>
            <div>
              <iframe ref="remoteFrame"
                ...
                src={`../dist/${this.state.width}x${this.state.height}-${this.state.modifier}/index.html`}
              ...
              <div className="textField text" >
                <p>{this.state.width}x{this.state.height}-{this.state.modifier} <span className="kbMargin">html</span> <span className="kbMargin">-</span>
            ...
            <div>
              <img
                width={this.state.width}
                height={this.state.height}
                src={`../dist/fallbacks/${this.state.width}x${this.state.height}-${this.state.modifier}.png`}
      ...
      if(this.state.modifier){
        return (
          <div className={this.state.className} style={{ flexGrow: '0.5' }}>
            <svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" width="100%" height="100vh" viewBox="0 0 100 100">
              <defs>
                <style></style>
