...
class HtmlFrame extends Component {
  ...
  render() {
    ...
    if( !this.state.modifier){
      iframSource = `/banners/${this.state.width}x${this.state.height}/index.html`;
      imageSource = `/banners/fallbacks/${this.state.width}x${this.state.height}.png`;
    }
    if (this.state.modifier) {
      iframSource = `/banners/${this.state.width}x${this.state.height}-${this.state.modifier}/index.html`;
      imageSource = `/banners/fallbacks/${this.state.width}x${this.state.height}-${this.state.modifier}.png`;
    }
